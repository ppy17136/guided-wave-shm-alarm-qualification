...
LOCK = ROOT / "research_protocols/P12_COPV_LOCK2_2_execution_freeze_v1.json"
LOCK_SHA = ROOT / "research_protocols/P12_COPV_LOCK2_2_SHA256_v1.txt"
READY = ROOT / "P12_COPV_LOCK2_2_READY.ok"
...
def main() -> None:
    ...
    checks = {"lock2_2_sha256": digest(LOCK) == expected}
    ...
    report = {"schema_version": "p12-copv-lock2-2-verification-v1", "passed": passed,
              "lock2_2_sha256": expected, "checks": checks}
    path = ROOT / "data/reports/p12_copv_lock2_2_cluster_verification.json"
